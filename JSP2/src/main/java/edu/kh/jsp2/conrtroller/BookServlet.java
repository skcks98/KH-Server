...
public class BookServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		bookList.add(new Book("JS 공부","이순신",24000));
		bookList.add(new Book("CSS 공부","짱구",60000));
		bookList.add(new Book("Servlet 공부","훈이",50000));
		bookList.add(new Book("JSP란?","철수",30000));
		bookList.add(new Book("Spring이란","유리",220000));
